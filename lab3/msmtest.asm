...
wind02 proc hParent:DWORD,lpIcon:DWORD,buffer:DWORD
    ...
    DlgStatic 'Password passed',SS_CENTER,10,10,120,9,100
	DlgStatic 'IM-13 Potapenko Misha',SS_CENTER,10,25,120,9,100
	DlgStatic 'Zalik book 1325',SS_CENTER,10,40,120,9,100
